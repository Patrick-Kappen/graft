...
// applyWorkspace copies all files from the workspace candidate back to the
// real source directory. New and modified files are applied; deleted files are
// left untouched on the host (safe default).

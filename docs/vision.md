...
No implicit container, mount, network, security policy, package, or agent.
...
## Candidate workspace for agents

For agents or safe project mutations:
...
```text
the real workspace is never automatically writable in the agent container
```

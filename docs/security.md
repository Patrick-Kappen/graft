...
This makes `graft up` mount a writable copy of the workspace and a temporary HOME/XDG tree. The real workspace and real home are not mounted writable by this flow.

See [`agent-update-flow.md`](agent-update-flow.md).
